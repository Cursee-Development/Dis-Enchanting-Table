...
public class FabricDisEnchantingBER implements BlockEntityRenderer<FabricDisEnchantingBE> {

    public FabricDisEnchantingBER(BlockEntityRendererProvider.Context context) {}
    ...
    @Override
    public void render(FabricDisEnchantingBE disEnchantingBE, float partialTick, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, int packedOverly) {
