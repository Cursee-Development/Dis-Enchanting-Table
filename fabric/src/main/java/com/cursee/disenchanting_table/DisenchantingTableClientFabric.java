...
public class DisenchantingTableClientFabric implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ClientPlayNetworking.registerGlobalReceiver(FabricNetwork.Packets.CONFIG_SYNC_ID, FabricConfigSyncS2CPacket::handle);
        ClientPlayNetworking.registerGlobalReceiver(FabricNetwork.Packets.ITEM_SYNC_ID, FabricItemSyncS2CPacket::handle);
    }
}
